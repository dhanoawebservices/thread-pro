      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="bg-white p-8 rounded-2xl border border-gray-200 shadow-lg">
            ...
            <p className="text-gray-600 mb-8">Get in touch with us and we'll get back to you within 24 hours.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:border-[#003366] text-gray-900 placeholder-gray-400"
                    placeholder="John"
                    required
                  />
                </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleInputChange}
                  rows={5}
                  className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:border-[#003366] text-gray-900 placeholder-gray-400 resize-none"
              ...
              <button
                type="submit"
                className="w-full bg-primary text-white px-8 py-4 rounded-lg transition-all duration-200 transform hover:scale-105 font-semibold flex items-center justify-center space-x-2"
              >
                <Send size={20} />
          ...
          <div className="space-y-8">
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">hello@threadpro.com</div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">123 Craft Street, Design City</div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    <div className="text-gray-900 font-semibold">Hours</div>
            ...
            <div className="bg-white p-6 rounded-2xl border border-gray-200 shadow-lg">
              <h3 className="text-xl font-bold text-gray-900 mb-4">Why Choose ThreadPro?</h3>
